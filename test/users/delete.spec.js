...
describe('DELETE /users', () => {
    ...
    context('Quando eu excluo um usuário', () => {
        const newUser = {
        ...
        it('Então deve retornar o statusCode = 204', (done) => {
            request
                .delete(`/users/${id}`)
                .auth(TOKEN, { type: 'bearer' })
                .then((res) => {
    ...
    context('Quando eu excluo um usuário inexistente', () => {
        it('Então deve retornar o statusCode = 404', (done) => {
            request
                .delete(`/users/${id}`)
                .auth(TOKEN, { type: 'bearer' })
                .then((res) => {
